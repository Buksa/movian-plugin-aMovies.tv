...
var UA = 'Mozilla/5.0 (X11; Ubuntu; Linux i686; rv:16.0) Gecko/20120815 Firefox/16.0';
...
io.httpInspectorCreate('http.*amovies.org/.*', function(ctrl) {
...
new page.Route(PREFIX + ":page:(.*)", function(page, href) {
